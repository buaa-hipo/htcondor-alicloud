...
ECSGahpClient::ECSGahpClient( const char * id, const char * path, const ArgList * args ) :
...
int ECSGahpClient::ecs_vm_start( const std::string & service_url,
								 ...
								 std::string &error_code)
{
	...
	// ECS_COMMAND_VM_START <req_id> <publickeyfile> <privatekeyfile> <ami-id> <keypair> <groupname> <groupname> ...
	static const char* command = "ECS_VM_START";
...
int ECSGahpClient::ecs_vm_stop(	const std::string & service_url,
								const std::string & publickeyfile,
								const std::string & privatekeyfile,
...
{
	// command line looks like:
	// ECS_COMMAND_VM_STOP <req_id> <publickeyfile> <privatekeyfile> <instance-id>
	static const char* command = "ECS_VM_STOP";
...
int ECSGahpClient::ecs_gahp_statistics( StringList & returnStatistics ) {
...
int ECSGahpClient::ecs_vm_status_all( const std::string & service_url,
                                      const std::string & publickeyfile,
                                      const std::string & privatekeyfile,
                                      StringList & returnStatus,
                                      std::string & error_code )
{
    static const char * command = "ECS_VM_STATUS_ALL";
...
int ECSGahpClient::ecs_ping(	const std::string & service_url,
								const std::string & publickeyfile,
								const std::string & privatekeyfile,
								std::string & error_code )
{
	// we can use "Status All" command to make sure ECS Server is alive.
	static const char* command = "ECS_VM_STATUS_ALL";
...
int ECSGahpClient::ecs_vm_server_type(	const std::string & service_url,
										const std::string & publickeyfile,
										const std::string & privatekeyfile,
...
{
	// we can use "Status All" command to make sure ECS Server is alive.
	static const char* command = "ECS_VM_SERVER_TYPE";
...
int ECSGahpClient::ecs_vm_create_keypair(	const std::string & service_url,
											const std::string & publickeyfile,
											const std::string & privatekeyfile,
...
{
	// command line looks like:
	// ECS_COMMAND_VM_CREATE_KEYPAIR <req_id> <publickeyfile> <privatekeyfile> <groupname> <outputfile> 
	static const char* command = "ECS_VM_CREATE_KEYPAIR";
...
int ECSGahpClient::ecs_vm_destroy_keypair(	const std::string & service_url,
											const std::string & publickeyfile,
											const std::string & privatekeyfile,
											const std::string & keyname,
											std::string & error_code )
{
	// command line looks like:
	// ECS_COMMAND_VM_DESTROY_KEYPAIR <req_id> <publickeyfile> <privatekeyfile> <groupname> 
	static const char* command = "ECS_VM_DESTROY_KEYPAIR";
...
int ECSGahpClient::ecs_associate_address( const std::string & service_url,
                                          const std::string & publickeyfile,
                                          const std::string & privatekeyfile,
                                          const std::string & instance_id,
                                          ...
                                          std::string & error_code )
{
    ...
    static const char* command = "ECS_VM_ASSOCIATE_ADDRESS";
...
// Not sure why this function always returns 0.
int ECSGahpClient::ecs_create_tags(	const std::string & service_url,
									const std::string & publickeyfile,
									const std::string & privatekeyfile,
									const std::string & instance_id,
									StringList &tags,
									...
									std::string &error_code)
{
    static const char* command = "ECS_VM_CREATE_TAGS";
...
// Not sure why this function always returns 0.
int ECSGahpClient::ecs_attach_volume( const std::string & service_url,
                                      const std::string & publickeyfile,
                                      const std::string & privatekeyfile,
                                      ...
                                      std::string & error_code )
{
    static const char* command = "ECS_VM_ATTACH_VOLUME";
...
//
int ECSGahpClient::ecs_spot_start( const std::string & service_url,
                                   const std::string & publickeyfile,
                                   const std::string & privatekeyfile,
                                   const std::string & ami_id,
                                   ...
                                   std::string & error_code )
{
    static const char * command = "ECS_VM_START_SPOT";
...
int ECSGahpClient::ecs_spot_stop( const std::string & service_url,
                                  const std::string & publickeyfile,
                                  const std::string & privatekeyfile,
                                  const std::string & request_id,
                                  std::string & error_code )
{
    static const char * command = "ECS_VM_STOP_SPOT";
...
int ECSGahpClient::ecs_spot_status_all( const std::string & service_url,
                                        const std::string & publickeyfile,
                                        const std::string & privatekeyfile,
                                        StringList & returnStatus,
                                        std::string & error_code )
{
    static const char * command = "ECS_VM_STATUS_ALL_SPOT";
...
int ECSGahpClient::bulk_start(	const std::string & service_url,
								const std::string & publickeyfile,
								const std::string & privatekeyfile,
...
int ECSGahpClient::bulk_start(	const std::string & service_url,
								...
								std::string & bulkRequestID,
								std::string & error_code ) {
	static const char * command = "ECS_BULK_START";
...
int ECSGahpClient::bulk_stop(	const std::string & service_url,
								const std::string & publickeyfile,
								const std::string & privatekeyfile,
								const std::string & bulkRequestID,
								std::string & error_code ) {
	static const char * command = "ECS_BULK_STOP";
...
int ECSGahpClient::bulk_query(	const std::string & service_url,
								const std::string & publickeyfile,
								const std::string & privatekeyfile,
								StringList & returnStatus,
								std::string & error_code ) {
	static const char * command = "ECS_BULK_QUERY";
...
int ECSGahpClient::put_rule(	const std::string & service_url,
								const std::string & publickeyfile,
								const std::string & privatekeyfile,
...
int ECSGahpClient::delete_rule(	const std::string & service_url,
								const std::string & publickeyfile,
								const std::string & privatekeyfile,
								const std::string & ruleName,
								std::string & error_code ) {
...
int ECSGahpClient::get_function(	const std::string & service_url,
									const std::string & publickeyfile,
									const std::string & privatekeyfile,
...
int ECSGahpClient::put_targets(	const std::string & service_url,
								const std::string & publickeyfile,
								const std::string & privatekeyfile,
								const std::string & ruleName,
								const std::string & id,
...
int ECSGahpClient::remove_targets(	const std::string & service_url,
									const std::string & publickeyfile,
									const std::string & privatekeyfile,
									const std::string & ruleName,
									const std::string & id,
...
int ECSGahpClient::s3_upload(	const std::string & service_url,
								const std::string & publickeyfile,
								const std::string & privatekeyfile,
...
int ECSGahpClient::describe_stacks(  const std::string & service_url,
	const std::string & publickeyfile,
	const std::string & privatekeyfile,
...
int ECSGahpClient::create_stack(
...
int ECSGahpClient::call_function(	const std::string & service_url,
									const std::string & publickeyfile,
									const std::string & privatekeyfile,
									const std::string & functionARN,
